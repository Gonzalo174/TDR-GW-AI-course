> **Documento histórico.** Es el documento de trabajo con el que se reorganizó
> la versión v4 del proyecto, antes de este repositorio. Se conserva como registro
> del camino recorrido: sus rutas (`gon4/`, `/home/...`), carpetas (`createDB/`,
> `reproducir_v6/`) y estado ya no corresponden a este repositorio. Las reglas que
> siguen vigentes están en [`CONVENCIONES.md`](../CONVENCIONES.md), y el estado del
> trabajo, en [`PLAN.md`](../PLAN.md).
...
**fuera del alcance de v4**: es una consulta pendiente con el grupo, no un análisis a
...
| `reproducir_v6/umbral_bioactividad/` | el corte 20 µM vs 2 µM es una consulta pendiente con el grupo, no un análisis de v4 (§7) |
...
**Consultas pendientes con el grupo** (no se ejecutan en v4):
