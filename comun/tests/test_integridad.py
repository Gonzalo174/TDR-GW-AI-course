...
class TestIntegridad(unittest.TestCase):
    ...
    def test_prefijos_de_anotacion(self):
        ...
        malos = self.d.sta.loc[~self.d.sta["ann"].str.startswith(("IPR", "OG")), "ann"]
    ...
    def test_coherencia_db_prefijo(self):
        ...
        self.assertTrue(ip["ann"].str.startswith("IPR").all())
    ...
    def test_tags_de_bioactividad_conocidos(self):
        esperados = {"positive", "negative", "indeterminate", "inconsistent"}
