...
{\small Nodo: lo que tiene la especie. Arista: lo que comparten dos. Más cerca, más compartido.}
\begin{columns}[T]
\column{.49\textwidth}
\centering
\includegraphics[height=.61\textheight]{figuras/02_f04_grafo_anotaciones.pdf}\\
...
\column{.49\textwidth}
\centering
\includegraphics[height=.61\textheight]{figuras/02_f05_grafo_drogas.pdf}\\
