...
\begin{frame}{Flujo de información}
{\small Las \NEspecies\ especies, en el mismo lugar, vistas desde cada capa.
Nodo: lo que tiene la especie; arista: lo que comparten dos.}
\begin{columns}[T]
\column{.49\textwidth}
\centering
\includegraphics[height=.56\textheight]{figuras/02_f04_grafo_anotaciones.pdf}\\
{\scriptsize\color{tinta2}\textbf{\color{azulo}Anotaciones:} todas con todas; el par
mediano comparte el \PesoRelAnotMediana\,\% de sus categorías. Por acá propaga la
priorización.}
\column{.49\textwidth}
\centering
\includegraphics[height=.56\textheight]{figuras/02_f05_grafo_drogas.pdf}\\
{\scriptsize\color{tinta2}\textbf{\color{naranja}Compuestos:} el par mediano comparte el
\PesoRelDrogMediana\,\%; \textit{H.\,sapiens} está en el \PctCompartidoHumano\,\% de lo
compartido. De acá arranca la desorfanización.}
\end{columns}
\end{frame}

% ------------------------------------------- 7 · resultados priorizacion
...
% ------------------------------------ 10 · resultados semilla informativa
